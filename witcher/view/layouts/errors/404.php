...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?= HTTP_SERVER ?>/witcherAssets/loaderAssets/vendor/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css"
          href="<?= HTTP_SERVER ?>/witcherAssets/loaderAssets/fonts/font-awesome-4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="<?= HTTP_SERVER ?>/witcherAssets/loaderAssets/vendor/animate/animate.css">
    <link rel="stylesheet" type="text/css" href="<?= HTTP_SERVER ?>/witcherAssets/loaderAssets/vendor/select2/select2.min.css">
...
<div class="simpleslide100">
    <div class="simpleslide100-item bg-img1" style="background-image: url('witcherAssets/loaderAssets/images/bg01.jpg');"></div>
    <div class="simpleslide100-item bg-img1" style="background-image: url('witcherAssets/loaderAssets/images/bg02.jpg');"></div>
    <div class="simpleslide100-item bg-img1" style="background-image: url('witcherAssets/loaderAssets/images/bg03.jpg');"></div>
</div>
    ...
    <div class="size1 flex-col-c-m p-l-15 p-r-15 p-t-50 p-b-50">
        ...
        <div class="flex-w flex-c-m cd100 p-b-33">
            ...
            <div class="flex-col-c-m size2 bor1 m-l-15 m-r-15 m-b-20">
                <span class="l2-txt1 p-b-9 seconds">404</span>
            </div>
        </div>
